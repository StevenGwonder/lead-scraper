...
def format_telegram_briefing(qualified: dict, trade: str, cities: list,
    ...
    lines.append("")
    lines.append("💡 Want this for YOUR business? We install a digital employee that knows your trade and gets better every week. 48-hour setup. $5k/mo unlimited — no tokens, no tech, just results.")
    lines.append("")
